...
IF(NOT WIN32)
	...
	IF(NOT OPENGL_gl_LIBRARY)
		MESSAGE("NO SE HA ENCONTRADO LA BIBLIOTECA GL")
	ENDIF(NOT OPENGL_gl_LIBRARY)
	
	IF(NOT OPENGL_glu_LIBRARY)
		MESSAGE("NO SE HA ENCONTRADO LA BIBLIOTECA GLU")
...
IF(OPENGL_gl_LIBRARY)
	MESSAGE("* Se ha encontrado la biblioteca GL en: " ${OPENGL_gl_LIBRARY})
ELSE(OPENGL_gl_LIBRARY)
	MESSAGE("NO SE HA ENCONTRADO LA BIBLIOTECA GL")
ENDIF(OPENGL_gl_LIBRARY)

IF(OPENGL_glu_LIBRARY)
	MESSAGE("* Se ha encontrado la biblioteca GLU en: " ${OPENGL_glu_LIBRARY})
ELSE(OPENGL_glu_LIBRARY)
	MESSAGE("NO SE HA ENCONTRADO LA BIBLIOTECA GLU")
ENDIF(OPENGL_glu_LIBRARY)

IF(IRRLICHT_INCLUDE_DIR)
	MESSAGE("* Se encontraron las cabeceras de Irrlicht en: " ${IRRLICHT_INCLUDE_DIR})
ELSE(IRRLICHT_INCLUDE_DIR)
	MESSAGE("NO SE HAN ENCONTRADO CABECERAS DE IRRLICHT")
ENDIF(IRRLICHT_INCLUDE_DIR)

IF(IRRLICHT_LIBRARY)
	MESSAGE("* Se ha encontrado la biblioteca Irrlicht en: " ${IRRLICHT_LIBRARY})
ELSE(IRRLICHT_LIBRARY)
	MESSAGE("SE HA LA BIBLITECA DE IRRLICHT")
ENDIF(IRRLICHT_LIBRARY)

IF(OPENAL_INCLUDE_DIR)
	MESSAGE("* Se han encontrado las cabeceras de OpenAL en: " ${OPENAL_INCLUDE_DIR})
ELSE(OPENAL_INCLUDE_DIR)
	MESSAGE("NO SE HAN ENCONTRADO CABECERAS DE OPENAL")
ENDIF(OPENAL_INCLUDE_DIR)

IF(OPENAL_LIBRARY)
	MESSAGE("* Se ha encontrado la bibliteca OpenAL en: " ${OPENAL_LIBRARY})
ELSE(OPENAL_LIBRARY)
	MESSAGE("NO SE HA ENCONTRADO LA BIBLIOTECA OPENAL")
ENDIF(OPENAL_LIBRARY)

IF(ALUT_INCLUDE_DIR)
	MESSAGE("* Se han encontrado las cabeceras de ALUT en: " ${ALUT_INCLUDE_DIR})
ELSE(ALUT_INCLUDE_DIR)
	MESSAGE("NO SE HAN ENCONTRADO CABECERAS DE ALUT")
ENDIF(ALUT_INCLUDE_DIR)

IF(ALUT_LIBRARY)
	MESSAGE("* Se ha encontrado la bibliteca ALUT en: " ${ALUT_LIBRARY})
ELSE(ALUT_LIBRARY)
	MESSAGE("NO SE HA ENCONTRADO LA BIBLIOTECA ALUT")
ENDIF(ALUT_LIBRARY)

IF(OGG_INCLUDE_DIR)
	MESSAGE("* Se han encontrado las cabeceras de Ogg en: " ${OGG_INCLUDE_DIR})
ELSE(OGG_INCLUDE_DIR)
	MESSAGE("NO SE HAN ENCONTRADO CABECERAS DE OGG")
ENDIF(OGG_INCLUDE_DIR)

IF(OGG_LIBRARY)
	MESSAGE("* Se ha encontrado la biblioteca Ogg en: " ${OGG_LIBRARY})
ELSE(OGG_LIBRARY)
	MESSAGE("NO SE HA ENCONTRADO LA BIBLIOTECA OGG")
ENDIF(OGG_LIBRARY)

IF(VORBIS_INCLUDE_DIR)
	MESSAGE("* Se han encontrado las cabeceras de Vorbis en: " ${VORBIS_INCLUDE_DIR})
ELSE(VORBIS_INCLUDE_DIR)
	MESSAGE("NO SE HAN ENCONTRADO CABECERAS DE VORBIS")
ENDIF(VORBIS_INCLUDE_DIR)

IF(VORBIS_LIBRARY)
	MESSAGE("* Se ha encontrado la biblioteca Vorbis en: " ${VORBIS_LIBRARY})
ELSE(VORBIS_LIBRARY)
	MESSAGE("NO SE HA ENCONTRADO LA BIBLIOTECA VORBIS")
ENDIF(VORBIS_LIBRARY)


IF(VORBIS_INCLUDE_DIR)
	MESSAGE("* Se han encontrado las cabeceras de Vorbisfile en: " ${VORBIS_INCLUDE_DIR})
ELSE(VORBIS_INCLUDE_DIR)
	MESSAGE("NO SE HA ENCONTRADO LA BIBLIOTECA VORBIS")
ENDIF(VORBIS_INCLUDE_DIR)

IF(VORBISFILE_LIBRARY)
	MESSAGE("* Se ha encontrado la biblioteca Vorbisfile en: " ${VORBISFILE_LIBRARY})
ELSE(VORBISFILE_LIBRARY)
	MESSAGE("NO SE HA ENCONTRADO LA BIBLIOTECA VORBISFILE")
...
IF(LUA_LIBRARY)
	MESSAGE("* Se ha encontrado la Biblioteca de LUA en: " ${LUA_LIBRARY})
ELSE(LUA_LIBRARY)
	MESSAGE("NO SE HA ENCONTRADO LA BIBLIOTECA LUA")
ENDIF(LUA_LIBRARY)

IF(NEWTON_LIBRARY)
	MESSAGE("* Se ha encontrado la biblioteca Newton Dynamics en: " ${NEWTON_LIBRARY})
ELSE(NEWTON_LIBRARY)
	MESSAGE("NO SE HA ENCONTRADO LA BIBLIOTECA NEWTON")
ENDIF(NEWTON_LIBRARY)

IF(NEWTON_INCLUDE_DIR)
	MESSAGE("* Se han encontrado las cabeceras de Newton Dynamics en: " ${NEWTON_LIBRARY})
