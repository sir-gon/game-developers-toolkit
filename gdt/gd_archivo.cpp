...
/*!
Copia en el buffer indicado el n̼mero de bytes que se quieren leer del archivo.
...
/*!
\return el n̼mero de bytes totales del archivo se est&aacute; leyendo, devuelve el n̼mero de bytes totales del archivo.
