...
\param bContinuar opcional. Hace que el archivo no se sobrescriba, sino que se escriba a continuaci�n de lo que ya hay.
...
\param bytes el n�mero de bytes que se escribir�n

Escribe el n�mero de bytes indicados de la cadena.
