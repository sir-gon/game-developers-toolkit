...
\return la raiz cuadrada del n&uacute;mero real x. Aquel n&uacute;mero que multiplicado por s�mismo es x.
...
Dicho �gulo es la tangente de la pendiente de la recta que uno los puntos \f$(x_1,y_1)\f$ con \f$(x_2, y_2)\f$. Esta basada en la ecuai� de la recta que pasa por 2 puntos.
...
Para mayor informaci� sobre el origen de la f�mula, lea <A HREF="http://es.wikipedia.org/wiki/Pendiente_de_una_recta">este art�ulo</A>.
*/
...
/*!
\bug Esta implementaci� siempre retorna 0.
*/
