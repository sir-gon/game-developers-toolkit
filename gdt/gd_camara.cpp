...
void GDT::Nodo::Camara::Crear(int tipo)
{
    ...
    if(!nodon) printf("ERROR: No se pudo Crear La c�ara.\n");    
}

/*!
\param x,y,z son las coordenadas de la posici� donde debe mirar la c&aacute;mara
*/
...
/*!
\param destino es un vector posici� al cual la c&aacute;mara debe apuntar.
*/
...
/*!
\return el vector posici� hacia donde est�mirando la c&aacute;mara.
*/
...
\param angulo es el �gulo a que esta la c&aacute;mara, es decir 270 esta atr� del objeto 90 a un lado del objeto etc.
\param durezaX,durezaY,durezaZ la dureza con la que se mueve la c&aacute;mara. Un valor bajo da mayor suavizado, un valor alto da una c&aacute;mara mas r�ida.
*/
